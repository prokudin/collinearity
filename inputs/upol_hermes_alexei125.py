...
# GK approximate
conf['params']['gk'] = {}
conf['params']['gk']['gk0'] = {'value': -2.41367e-01, 'min': -1.3, 'max': 0, 'fixed': False}
conf['params']['gk']['Q0'] = {'value': 1.69000e+00, 'min': 0.8, 'max': 4, 'fixed': True}

# TMD PDF:
conf['params']['pdf'] = {}
conf['params']['pdf']['widths1_uv'] = {'value': 3.23171e-01, 'min': 0.1, 'max': 0.7, 'fixed': False}
conf['params']['pdf']['widths2_uv'] = {'value': 0.00000e+00, 'min': -1, 'max': 1, 'fixed': True}
conf['params']['pdf']['widths1_dv'] = {'value': 3.23171e-01, 'min': 0, 'max': 1, 'fixed': 'widths1_uv'}
conf['params']['pdf']['widths2_dv'] = {'value': 0.00000e+00, 'min': -1, 'max': 1, 'fixed': 'widths2_uv'}
conf['params']['pdf']['widths1_sea'] = {'value': 4.12613e-01, 'min': 0.1, 'max': 0.9, 'fixed': False}
conf['params']['pdf']['widths2_sea'] = {'value': 0.00000e+00, 'min': -1, 'max': 1, 'fixed': True}

# TMD FF:
conf['params']['ffpi'] = {}
conf['params']['ffpi']['widths1_fav'] = {'value': 2.07327e-01, 'min': 0, 'max': 0.5, 'fixed': False}
conf['params']['ffpi']['widths2_fav'] = {'value': 0.00000e+00, 'min': -1, 'max': 1, 'fixed': True}
conf['params']['ffpi']['widths1_ufav'] = {'value': 1.93139e-01, 'min': 0, 'max': 0.5, 'fixed': False}
conf['params']['ffpi']['widths2_ufav'] = {'value': 0.00000e+00, 'min': -1, 'max': 1, 'fixed': True}
conf['params']['ffk'] = {}
conf['params']['ffk']['widths1_fav'] = {'value': 2.29261e-01, 'min': 0, 'max': 0.5, 'fixed': False}
conf['params']['ffk']['widths2_fav'] = {'value': 0.00000e+00, 'min': -1, 'max': 1, 'fixed': True}
conf['params']['ffk']['widths1_ufav'] = {'value': 1.19686e-01, 'min': 0, 'max': 0.5, 'fixed': False}
...
#conf['datasets']['sidis']['filters']=["z<0.6 and Q2>1.69 and pT>0.2 and pT<0.9 and dy>1.25"]

conf['datasets']['sidis']['filters'] = ["z>0.2 and z<0.6  and Q2>1.69 and (pT/z)**2<0.15*Q2 and dy>1.25"]
