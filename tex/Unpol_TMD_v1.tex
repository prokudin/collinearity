...
\end{equation}
For the situation where $P_{hT}\ll Q$, one finds at leading-power the unpolarized cross section~\cite{Bacchetta:2006tn},
\begin{eqnarray}
\frac{d\sigma}
...
depend the scale of the reaction $Q^2$,  through   the renormalization scale, $\mu_Q$, and  rapidity scales  $\zeta_N$ and $\zeta_h$ from solving the Collins-Soper equation for the TMDs. The latter satisfy $\zeta_N=\zeta_h=Q^2$
scale which parameterizes the effects of soft gluons
...
\begin{eqnarray}
&&\tilde f_{a/p} (x,b_T; Q^2, \mu_Q)= \tilde f_{a/p} (x, b_T; Q_0^2, \mu_0)\,e^{-S(b_T, Q, \mu_Q, Q_0, \mu_0)/2}\,,
