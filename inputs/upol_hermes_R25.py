...
# GK approximate
conf['params']['gk']={}
conf['params']['gk']['gk0']  ={'value':   -2.57673e-01,'min': -1.3,'max':0,'fixed':False}
conf['params']['gk']['Q0']  ={'value':    1.69000e+00,'min':0.8,'max':4,'fixed':True}

# TMD PDF:
conf['params']['pdf']={}
conf['params']['pdf']['widths1_uv']  ={'value':    4.03007e-01,'min': 0.1,'max':0.7,'fixed':False}
conf['params']['pdf']['widths2_uv']  ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}
conf['params']['pdf']['widths1_dv']  ={'value':    4.03007e-01,'min': 0,'max':1,'fixed':'widths1_uv'}
...
# TMD FF:
conf['params']['ffpi']={}
conf['params']['ffpi']['widths1_fav']   ={'value':    2.34644e-01,'min': 0.05,'max':0.5,'fixed':False}
conf['params']['ffpi']['widths2_fav']   ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}
conf['params']['ffpi']['widths1_ufav'] ={'value':    2.21485e-01,'min': 0.001,'max':0.5,'fixed':False}
