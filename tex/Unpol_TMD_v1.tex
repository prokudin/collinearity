...
\newcommand{\rapav}{\ensuremath{y_{\rm ave}}}
\newcommand{\ratiotar}{\ensuremath{R_{\rm t}}}
\newcommand{\deltam}[2]{\ensuremath{\delta_{#1}^{#2}}}
...
\label{eq:xn.xbj}
\end{equation}
%and equals $\xbj$ when $M_p$ is neglected with respect to $Q$.
...
%  Their values are not directly determined experimentally, of course.
...
%For these, the deviations are controlled by the
%the transverse masses  $\Tsc{M}{\rm (i/f)}$;   The errors from this
%source are a modest factor times $\Tsc{M}{\rm i}^2/Q^2$ and of
%$\Tsc{M}{\rm f}^2/Q^2$ 
...
%in terms of the quark and hadron rapidities and their errors.
%The conditions on $\ratiocur$ or $\hady$ can be translated into regions of $\zh$ and $\Tsc{P}{\rm h}$.}
