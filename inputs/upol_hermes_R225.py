...
# GK approximate
conf['params']['gk']={}
conf['params']['gk']['gk0']  ={'value':   -1.92422e-01,'min': -1.3,'max':0,'fixed':False}
conf['params']['gk']['Q0']  ={'value':    1.69000e+00,'min':0.8,'max':4,'fixed':True}

# TMD PDF:
conf['params']['pdf']={}
conf['params']['pdf']['widths1_uv']  ={'value':    3.49576e-01,'min': 0.1,'max':0.7,'fixed':False}
conf['params']['pdf']['widths2_uv']  ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}
conf['params']['pdf']['widths1_dv']  ={'value':    3.49576e-01,'min': 0,'max':1,'fixed':'widths1_uv'}
conf['params']['pdf']['widths2_dv']  ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':'widths2_uv'}
conf['params']['pdf']['widths1_sea'] ={'value':    1.00000e-04,'min': 0.0001,'max':0.9,'fixed':False}
conf['params']['pdf']['widths2_sea'] ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}

# TMD FF:
conf['params']['ffpi']={}
conf['params']['ffpi']['widths1_fav']   ={'value':    2.41516e-01,'min': 0.05,'max':0.5,'fixed':False}
conf['params']['ffpi']['widths2_fav']   ={'value':    0.00000e+00,'min':-1,'max':1,'fixed':True}
conf['params']['ffpi']['widths1_ufav'] ={'value':    2.45169e-01,'min': 0.001,'max':0.5,'fixed':False}
...
conf['datasets']['sidis']['filters']=["z>0.2 and z<0.6  and Q2>1.69 and lnR<-2.25"]
